...
def add_classes(model_description, selected_layer):
    ...
    for layer in model_description['config']['layers']:
        if layer['class_name'] != 'ErrorSimulator' and layer['inbound_nodes'][0][0][0] == selected_layer:
...
def save_model_with_classes(modified_description):
    ...
    modified_model_file.attrs.create('model_config', modified_description.encode('utf-8'))
